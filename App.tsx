...
const STATIC_PAGES: Article[] = [
  ...
  { 
    ...
    content: `
      ...
      <p>
        <strong>Daniel Sartison</strong><br>
        Carl-Zuckmayer-Straße 16<br>
        68169 Mannheim
      </p>
      <p>
        Telefon: +49 17643493281<br>
        E-Mail: info@dsmediasolutions.de
      </p>
      ...
      <h3>Squarespace Analytics</h3>
      <p>Wir nutzen Squarespace Analytics auf dieser Website. Anbieter ist die Squarespace Ireland Ltd., Le Pole House, Shipstreet Great, Dublin 8, Irland (nachfolgend Squarespace Analytics).</p>
      <p>Squarespace Analytics ermöglicht es uns, das Nutzerverhalten unserer Websitebesucher zu erfassen und auszuwerten. Im Rahmen der Nutzeranalyse können wir Ihr Klick- und Scrollverhalten, Suchvorgänge, Zeitpunkt des Zugriffs, Ihre geografische Lage und den Zugriff auf interne Links analysieren. Zu diesem Zweck erfasst Squarespace Analytics u. a. Informationen über Ihren Browser, Ihr Netzwerk, Ihr Gerät und Ihre IP-Adresse.</p>
      <p>Squarespace Analytics verwendet Technologien, die die seitenübergreifende Wiedererkennung des Nutzers zur Analyse des Nutzerverhaltens ermöglichen (z. B. Cookies oder Device-Fingerprinting) und bildet auf dieser Grundlage pseudonymisierte Nutzerprofile.</p>
      <p>Im Rahmen der Analyse können auch personenbezogene Daten an das Mutterunternehmen von Squarespace Analytics, die Squarespace Inc., 8 Clarkson St, New York, NY 10014, USA übermittelt werden.</p>
      ...
      <p>Die Datenübertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission gestützt. Details finden Sie hier: <a href="https://support.squarespace.com/hc/de/articles/360000851908-DSGVO-und-Squarespace" target="_blank" rel="noopener noreferrer">https://support.squarespace.com/hc/de/articles/360000851908-DSGVO-und-Squarespace</a>.</p>
      <p>Das Unternehmen verfügt über eine Zertifizierung nach dem „EU-US Data Privacy Framework“ (DPF). Der DPF ist ein Übereinkommen zwischen der Europäischen Union und den USA, der die Einhaltung europäischer Datenschutzstandards bei Datenverarbeitungen in den USA gewährleisten soll. Jedes nach dem DPF zertifizierte Unternehmen verpflichtet sich, diese Datenschutzstandards einzuhalten. Weitere Informationen hierzu erhalten Sie vom Anbieter unter folgendem Link: <a href="https://www.dataprivacyframework.gov/participant/4774" target="_blank" rel="noopener noreferrer">https://www.dataprivacyframework.gov/participant/4774</a>.</p>
